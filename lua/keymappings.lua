...
vim.api.nvim_set_keymap("n", "<leader>ss", [[<cmd>lua require'persistence'.load()<cr>]], { nowait = true, silent = true, noremap = true })

-- restore the last session
vim.api.nvim_set_keymap("n", "<leader>sl", [[<cmd>lua require'persistence'.load({ last = true })<cr>]], { nowait = true, silent = true, noremap = true })

-- stop Persistence => session won't be saved on exit
vim.api.nvim_set_keymap("n", "<leader>sq", [[<cmd>lua require'persistence'.stop()<cr>]], { nowait = true, silent = true, noremap = true })
